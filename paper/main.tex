...
algorithms~\citep{DiazFEABC2023,DiazICAE2023} and irace-tuned tabu search
with dedicated neighbourhood structures~\citep{DiazTS2026} reach mean
relative errors (RE, measured against crisp Taillard lower bounds)
between roughly $0\%$ and $16\%$ depending on the method and the size
class. The price
...
artificial bee colony algorithms~\citep{DiazFEABC2023,DiazICAE2023} and
to tabu search with specialized neighbourhoods~\citep{DiazTS2026}; these
...
convention~\citep{DiazICAE2023,DiazTS2026}:
\begin{equation}
...
anchor the recent IJSP literature~\citep{DiazFEABC2023,DiazICAE2023,
...
metaheuristics (fEABC~\citep{DiazFEABC2023}, ESABC~\citep{DiazICAE2023},
TS~\citep{DiazTS2026}; 30 runs and minutes of per-instance search on
...
($3.7\%$ mean RE for the tuned tabu search and $9.4\%$ for fEABC,
30-run averages)---establishing, for the IJSP, the computational-class
...
search~\citep{DiazTS2026}, are the subject of dedicated ongoing work.
