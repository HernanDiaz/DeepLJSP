...
makes each piece precise: Section~\ref{sec:mdp} states the
construction loop formally (states, actions, rewards);
Section~\ref{sec:features} describes what the policy \emph{sees},
i.e.\ how a candidate operation and the shop state become a handful
of numbers; Section~\ref{sec:arch}, how those numbers become a
choice; and Section~\ref{sec:training}, how the network is trained
and used afterwards.
