...
the same ($p=0.31$). Two departures of this confirmation from the
main protocol should be noted: the statistical unit just given, and
that both of its arms transfer weights from the immediately preceding
block rather than from the best block so far, symmetrically. Two
