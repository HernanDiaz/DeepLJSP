# -*- coding: utf-8 -*-
"""Depositos de rollouts de la ampliacion a diez semillas (5-11).
...
depositos originales, que no se tocan.
    ...
    python scripts/eval_lambda_ext_rollouts.py --carril 0 --de 6

Salida NUEVA: benchmarks/robust_lambda/rollouts_ext_<carril>.csv
"""
import argparse
import csv
import glob
...
BRAZOS = [("base", ["v2-full-1000ep-ext-c"]),
          ("lam0p5", ["v2-robust-lam0p5-ext"]),
          ("lam1", ["v2-robust-lam1-ext", "v2-robust-lam1-ext-b"]),
          ("lam2", ["v2-robust-lam2-ext"]),
          ("lam4", ["v2-robust-lam4-ext"])]
...
def main():
    ...
    args = ap.parse_args()
    salida = f"benchmarks/robust_lambda/rollouts_ext_{args.carril}.csv"
