"""
Problema tai20_15_09.F.15_01 para Job Shop Scheduling.
"""

# Configuración del problema tai20_15_09.F.15_01
# 20 trabajos x 15 máquinas

tai20_15_09_F_15_01_DATA = {
    'num_jobs': 20,
    'num_machines': 15,
    ...
    'durations': [[78, 22, 89, 46, 42, 59, 13, 90, 41, 69, 71, 13, 48, 97, 62], [87, 56, 44, 1, 74, 3, 89, 77, 29, 17, 12, 60, 92, 35, 24], [57, 6, 73, 36, 57, 25, 94, 21, 46, 89, 47, 2, 57, 67, 55], [74, 40, 1, 37, 52, 84, 50, 39, 65, 80, 44, 70, 25, 27, 12], [15, 72, 25, 69, 8, 96, 14, 13, 31, 74, 13, 91, 39, 57, 46], [95, 2, 68, 22, 40, 33, 36, 32, 50, 32, 10, 63, 85, 16, 1], [15, 98, 21, 10, 35, 76, 29, 64, 34, 25, 88, 30, 52, 43, 45], [14, 21, 86, 2, 19, 78, 92, 85, 54, 61, 6, 13, 85, 87, 43], [8, 58, 67, 16, 99, 33, 14, 47, 21, 77, 64, 29, 73, 10, 47], [55, 84, 55, 26, 83, 6, 99, 51, 28, 63, 93, 52, 86, 68, 46], [43, 19, 32, 36, 18, 60, 97, 13, 48, 36, 79, 14, 69, 15, 23], [12, 68, 36, 72, 90, 68, 28, 13, 18, 68, 49, 52, 50, 63, 10], [76, 75, 73, 40, 58, 23, 6, 31, 5, 16, 73, 41, 47, 67, 37], [93, 58, 58, 93, 21, 90, 13, 82, 6, 62, 52, 44, 4, 29, 20], [98, 66, 63, 63, 71, 9, 10, 94, 93, 77, 47, 40, 24, 96, 56], [33, 18, 95, 80, 87, 3, 72, 18, 30, 32, 93, 10, 86, 58, 45], [69, 83, 62, 77, 41, 13, 8, 87, 3, 65, 40, 11, 32, 71, 86], [21, 77, 76, 77, 61, 82, 76, 42, 6, 88, 51, 50, 29, 63, 18], [87, 16, 98, 27, 58, 59, 69, 95, 85, 80, 97, 88, 11, 8, 42], [25, 16, 20, 67, 85, 74, 48, 44, 95, 28, 66, 34, 25, 94, 19]],
    'name': 'tai20_15_09.F.15_01'
}

def get_tai20_15_09_f_15_01_problem():
    """
    Obtiene los datos del problema tai20_15_09.F.15_01.
    
    Returns:
        Diccionario con los datos del problema tai20_15_09.F.15_01
    """
    return tai20_15_09_F_15_01_DATA
