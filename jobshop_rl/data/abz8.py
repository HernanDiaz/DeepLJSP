"""
Problema ABZ8 - 20 trabajos x 15 máquinas
Fuente: Adams, Balas, y Zawack
"""

def get_abz8_problem():
    """
    Retorna los datos del problema ABZ8 (20 trabajos x 15 máquinas).
    ...
    # Secuencias de máquinas para cada trabajo [0-14]
    sequences = [
    ...
    # Duraciones de procesamiento para cada operación
    durations = [
