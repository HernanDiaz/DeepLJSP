"""
Problema tai15_15_03.F.15_01 para Job Shop Scheduling.
"""

# Configuración del problema tai15_15_03.F.15_01
# 15 trabajos x 15 máquinas

tai15_15_03_F_15_01_DATA = {
    'num_jobs': 15,
    'num_machines': 15,
    ...
    'durations': [[69, 81, 81, 62, 80, 3, 38, 62, 54, 66, 88, 82, 3, 12, 88], [83, 51, 47, 15, 89, 76, 52, 18, 22, 85, 26, 30, 5, 89, 22], [62, 47, 93, 54, 38, 78, 71, 96, 19, 33, 44, 71, 90, 9, 21], [33, 82, 80, 30, 96, 31, 11, 26, 41, 55, 12, 10, 92, 3, 75], [36, 49, 10, 43, 69, 72, 19, 65, 37, 57, 32, 11, 73, 89, 12], [83, 32, 6, 13, 87, 94, 36, 76, 46, 30, 56, 62, 32, 52, 72], [29, 78, 21, 27, 17, 43, 14, 15, 16, 49, 72, 19, 99, 38, 64], [12, 74, 4, 3, 15, 62, 50, 38, 49, 25, 18, 55, 5, 71, 27], [69, 13, 33, 47, 86, 31, 97, 48, 25, 40, 94, 22, 61, 59, 16], [27, 4, 35, 80, 49, 46, 84, 46, 96, 72, 18, 23, 96, 74, 23], [36, 17, 81, 67, 47, 5, 51, 23, 82, 35, 96, 7, 54, 92, 38], [78, 58, 62, 43, 1, 56, 76, 49, 80, 26, 79, 9, 24, 24, 42], [38, 86, 38, 38, 83, 36, 11, 17, 99, 14, 57, 64, 58, 96, 17], [10, 86, 93, 63, 61, 62, 75, 90, 40, 77, 8, 27, 96, 69, 64], [73, 12, 14, 71, 3, 47, 84, 84, 53, 58, 95, 87, 90, 68, 75]],
    'name': 'tai15_15_03.F.15_01'
}

def get_tai15_15_03_f_15_01_problem():
    """
    Obtiene los datos del problema tai15_15_03.F.15_01.
    
    Returns:
        Diccionario con los datos del problema tai15_15_03.F.15_01
    """
    return tai15_15_03_F_15_01_DATA
