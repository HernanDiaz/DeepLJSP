"""
Problema tai15_15_07.F.15_01 para Job Shop Scheduling.
"""

# Configuración del problema tai15_15_07.F.15_01
# 15 trabajos x 15 máquinas

tai15_15_07_F_15_01_DATA = {
    'num_jobs': 15,
    'num_machines': 15,
    ...
    'durations': [[52, 19, 6, 20, 1, 26, 90, 44, 27, 18, 51, 80, 10, 51, 41], [44, 85, 2, 78, 86, 88, 61, 20, 56, 12, 69, 34, 55, 34, 84], [62, 72, 74, 63, 95, 29, 24, 34, 89, 83, 90, 26, 98, 65, 31], [10, 15, 93, 79, 77, 61, 1, 48, 22, 27, 21, 17, 45, 96, 11], [83, 52, 70, 78, 7, 28, 97, 52, 29, 81, 60, 91, 80, 54, 35], [3, 31, 98, 97, 77, 39, 41, 10, 9, 93, 7, 49, 20, 45, 59], [28, 93, 4, 51, 67, 5, 18, 52, 47, 21, 49, 63, 96, 85, 90], [25, 82, 58, 15, 67, 50, 66, 92, 56, 82, 57, 16, 34, 99, 61], [82, 31, 22, 16, 87, 48, 59, 63, 29, 99, 48, 36, 91, 61, 59], [28, 25, 69, 65, 62, 57, 97, 31, 15, 25, 83, 98, 55, 66, 31], [20, 99, 13, 88, 25, 75, 90, 84, 70, 41, 17, 54, 63, 1, 95], [59, 22, 46, 10, 1, 21, 3, 84, 93, 59, 78, 73, 59, 42, 63], [72, 80, 12, 56, 22, 8, 93, 27, 17, 38, 26, 51, 43, 80, 94], [72, 78, 29, 90, 46, 46, 43, 75, 90, 29, 8, 92, 16, 62, 6], [89, 44, 41, 32, 10, 85, 16, 23, 91, 46, 35, 17, 93, 45, 93]],
    'name': 'tai15_15_07.F.15_01'
}

def get_tai15_15_07_f_15_01_problem():
    """
    Obtiene los datos del problema tai15_15_07.F.15_01.
    
    Returns:
        Diccionario con los datos del problema tai15_15_07.F.15_01
    """
    return tai15_15_07_F_15_01_DATA
