"""
Problema tai20_15_07.F.15_01 para Job Shop Scheduling.
"""

# Configuración del problema tai20_15_07.F.15_01
# 20 trabajos x 15 máquinas

tai20_15_07_F_15_01_DATA = {
    'num_jobs': 20,
    'num_machines': 15,
    ...
    'durations': [[40, 57, 95, 33, 72, 31, 55, 36, 92, 72, 80, 39, 3, 86, 29], [20, 56, 68, 49, 35, 58, 90, 52, 97, 95, 94, 32, 56, 71, 83], [98, 5, 97, 85, 31, 5, 16, 19, 75, 50, 23, 63, 89, 65, 24], [80, 58, 41, 34, 94, 63, 8, 75, 60, 42, 38, 3, 73, 79, 36], [71, 65, 26, 59, 54, 69, 86, 86, 43, 7, 35, 86, 99, 94, 99], [82, 70, 53, 74, 58, 70, 50, 37, 90, 22, 9, 98, 30, 94, 43], [71, 63, 65, 15, 39, 93, 97, 67, 5, 61, 64, 68, 2, 31, 17], [7, 10, 65, 63, 92, 90, 85, 81, 32, 62, 5, 21, 5, 49, 36], [9, 31, 77, 49, 24, 67, 66, 37, 82, 69, 63, 4, 62, 52, 66], [67, 73, 87, 28, 43, 13, 18, 73, 69, 20, 97, 73, 64, 8, 13], [85, 30, 80, 64, 18, 72, 66, 72, 28, 13, 17, 55, 17, 42, 58], [87, 36, 87, 27, 23, 72, 49, 79, 30, 17, 57, 56, 82, 4, 66], [6, 62, 78, 78, 62, 17, 43, 18, 53, 16, 66, 20, 69, 49, 4], [34, 89, 23, 69, 12, 59, 50, 57, 85, 16, 55, 82, 61, 5, 36], [71, 19, 96, 9, 85, 88, 3, 68, 52, 29, 29, 22, 10, 9, 65], [23, 34, 73, 34, 85, 40, 73, 15, 51, 91, 1, 43, 7, 63, 7], [18, 62, 97, 49, 4, 71, 68, 51, 42, 40, 32, 92, 11, 46, 99], [1, 93, 46, 12, 11, 82, 56, 39, 84, 43, 77, 22, 23, 47, 43], [98, 38, 92, 72, 78, 70, 47, 32, 84, 84, 63, 95, 59, 26, 14], [80, 53, 72, 9, 89, 30, 35, 34, 52, 87, 97, 34, 73, 68, 31]],
    'name': 'tai20_15_07.F.15_01'
}

def get_tai20_15_07_f_15_01_problem():
    """
    Obtiene los datos del problema tai20_15_07.F.15_01.
    
    Returns:
        Diccionario con los datos del problema tai20_15_07.F.15_01
    """
    return tai20_15_07_F_15_01_DATA
