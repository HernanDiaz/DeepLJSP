"""
Problema tai15_15_01.F.15_01 para Job Shop Scheduling.
"""

# Configuración del problema tai15_15_01.F.15_01
# 15 trabajos x 15 máquinas

tai15_15_01_F_15_01_DATA = {
    'num_jobs': 15,
    'num_machines': 15,
    ...
    'durations': [[94, 66, 10, 53, 26, 15, 65, 82, 10, 27, 93, 92, 96, 70, 83], [74, 31, 88, 51, 57, 78, 8, 7, 91, 79, 18, 51, 18, 99, 33], [4, 82, 40, 86, 50, 54, 21, 6, 54, 68, 82, 20, 39, 35, 68], [73, 23, 30, 30, 53, 94, 58, 93, 32, 91, 30, 56, 27, 92, 9], [78, 23, 21, 60, 36, 29, 95, 99, 79, 76, 93, 42, 52, 42, 96], [29, 61, 88, 70, 16, 31, 65, 83, 78, 26, 50, 87, 62, 14, 30], [18, 75, 20, 4, 91, 68, 19, 54, 85, 73, 43, 24, 37, 87, 66], [32, 52, 9, 49, 61, 35, 99, 62, 6, 62, 7, 80, 3, 57, 7], [85, 30, 96, 91, 13, 87, 82, 83, 78, 56, 85, 8, 66, 88, 15], [5, 59, 30, 60, 41, 17, 66, 89, 78, 88, 69, 45, 82, 6, 13], [90, 27, 1, 8, 91, 80, 89, 49, 32, 28, 90, 93, 6, 35, 73], [47, 43, 75, 8, 51, 3, 84, 34, 28, 60, 69, 45, 67, 58, 87], [65, 62, 97, 20, 31, 33, 33, 77, 50, 80, 48, 90, 75, 96, 44], [28, 21, 51, 75, 17, 89, 59, 56, 63, 18, 17, 30, 16, 7, 35], [57, 16, 42, 34, 37, 26, 68, 73, 5, 8, 12, 87, 83, 20, 97]],
    'name': 'tai15_15_01.F.15_01'
}

def get_tai15_15_01_f_15_01_problem():
    """
    Obtiene los datos del problema tai15_15_01.F.15_01.
    
    Returns:
        Diccionario con los datos del problema tai15_15_01.F.15_01
    """
    return tai15_15_01_F_15_01_DATA
