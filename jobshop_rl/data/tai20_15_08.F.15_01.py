"""
Problema tai20_15_08.F.15_01 para Job Shop Scheduling.
"""

# Configuración del problema tai20_15_08.F.15_01
# 20 trabajos x 15 máquinas

tai20_15_08_F_15_01_DATA = {
    'num_jobs': 20,
    'num_machines': 15,
    ...
    'durations': [[70, 6, 29, 55, 14, 33, 66, 14, 7, 57, 55, 18, 62, 46, 92], [30, 53, 19, 1, 98, 81, 63, 62, 10, 15, 73, 75, 80, 84, 97], [42, 61, 6, 60, 24, 70, 78, 11, 35, 38, 61, 90, 74, 1, 60], [76, 84, 72, 17, 27, 86, 84, 71, 90, 27, 13, 98, 3, 57, 66], [38, 58, 80, 24, 50, 76, 6, 12, 26, 14, 35, 38, 55, 33, 42], [77, 87, 59, 19, 84, 85, 63, 51, 18, 29, 2, 13, 1, 25, 54], [19, 83, 71, 22, 4, 68, 68, 88, 80, 55, 11, 19, 39, 68, 37], [38, 98, 11, 3, 33, 43, 19, 90, 56, 83, 76, 97, 2, 76, 1], [25, 65, 88, 56, 75, 48, 40, 19, 39, 40, 43, 99, 23, 74, 39], [97, 66, 54, 29, 23, 9, 74, 46, 85, 98, 74, 12, 71, 65, 25], [3, 40, 81, 74, 67, 93, 76, 16, 12, 67, 52, 20, 24, 71, 90], [13, 59, 95, 79, 46, 16, 67, 67, 64, 85, 85, 27, 26, 56, 1], [64, 1, 29, 66, 32, 35, 8, 26, 94, 94, 62, 42, 60, 56, 7], [3, 7, 40, 93, 55, 75, 25, 21, 30, 82, 1, 58, 53, 88, 19], [66, 88, 48, 77, 38, 78, 16, 41, 93, 38, 25, 51, 14, 98, 61], [33, 23, 7, 60, 74, 54, 2, 22, 32, 15, 79, 83, 69, 41, 19], [61, 26, 66, 85, 34, 15, 59, 75, 3, 80, 39, 69, 6, 73, 65], [96, 6, 52, 22, 35, 79, 16, 72, 29, 26, 52, 58, 57, 31, 74], [42, 79, 84, 25, 70, 90, 8, 60, 81, 88, 11, 71, 61, 49, 81], [52, 3, 57, 66, 88, 42, 23, 72, 97, 91, 50, 43, 82, 62, 27]],
    'name': 'tai20_15_08.F.15_01'
}

def get_tai20_15_08_f_15_01_problem():
    """
    Obtiene los datos del problema tai20_15_08.F.15_01.
    
    Returns:
        Diccionario con los datos del problema tai20_15_08.F.15_01
    """
    return tai20_15_08_F_15_01_DATA
